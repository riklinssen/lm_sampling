    ...
    for station in sampled_clusters_gdf['station_name'].unique():
        ...
        folium.GeoJson(
            ...
            tooltip=folium.GeoJsonTooltip(
                fields=['station_name', 'cluster_type', 'population_count', 'centroid_lon', 'centroid_lat','grid_id' ],
                aliases=['Station', 'Type', 'Population', 'location of cluster centroid (lon)', 'location of cluster centroid (lat)', 'cluster identifier (grid_id)'],
